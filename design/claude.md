...
## Repository language
- **The working language of this repository is English.** All `.md` deliverables (READMEs, `docs/` — incl. `docs/internal/EPICS.md` and `docs/internal/stories/` —, this file) and all code comments are written in **English**.
